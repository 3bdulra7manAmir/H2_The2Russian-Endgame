...
_id_C6C5()
{
    ...
    if ( common_scripts\utility::flag( "bloody_player_rig" ) )
        ...
        level.player_rig setmodel( "h2_viewbody_airport" ); //here
...
_id_C25B( var_0 )
{
    var_1 = _id_B7B3();
    var_0 = _id_B991();
    level.scr_model["player_body"] = "h2_viewbody_airport"; //here
...
_id_AA80()
{
    level.price codescripts\character::setheadmodel( "head_airport_yuri" );
}

_id_C454()
{
    level._id_B416 codescripts\character::setheadmodel( "h2_head_vil_makarov" );
}
