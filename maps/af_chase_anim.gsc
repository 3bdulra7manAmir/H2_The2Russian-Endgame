...
_id_A902()
{
    ...
    if ( level.script == "ending" )
    {
        ...
        chicken_anims();
        model_anims();
        maps\_load::set_player_viewhand_model( "viewhands_airport" ); //here
...
_id_B405()
{
    ...
    level.scr_model["worldbody"] = "h2_viewbody_airport"; //here
...
player_animations()
{
    ...
    level.scr_model["dizzy_stumble"] = "viewhands_airport"; //here
